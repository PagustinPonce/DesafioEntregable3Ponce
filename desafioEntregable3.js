...
export class ProductManager{
    ...
    async addProduct(titulo,descripcion,precio,thumbnail,stock,code){
        ...
        try{
            ...
            await fs.promises.writeFile('./data.json', JSON.stringify(this.#products, null, '\t'),'utf-8')
...
productManager.addProduct('Producto pueba', 'Este es un producto prueba', 200, 'sin imagen', 25, 'abc126')
productManager.addProduct('Producto pueba', 'Este es un producto prueba', 200, 'sin imagen', 25, 'abc127')
productManager.addProduct('Producto pueba', 'Este es un producto prueba', 200, 'sin imagen', 25, 'abc128')
